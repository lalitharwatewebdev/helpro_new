...
class CartTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            //         $delete_route = route('admin.carts.destroy', $row->id);
            //         $edit_route = route('admin.carts.edit', $row->id);
            //         $edit_callback = 'setValue';
            //         $modal = '#edit-cart-modal';
            ...
            //         $route = route('admin.carts.status');
    ...
    public function filters(): array
    {
        return [
            ...
            //     ])
            //     ->filter(function (Builder $builder, string $value) {
            //         $builder->where('carts.name', 'like', '%' . $value . '%');
            //     }),
        ];
    }
    ...
    {
        $modelData = new Cart;
        return Excel::download(new CustomExport($this->getSelected(), $modelData), 'carts.xlsx');
    }
}
