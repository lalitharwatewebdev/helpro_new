...
class SubscriptionTable extends DataTableComponent
{
        ...
        return [
            ...
            Column::make('Actions')
                ->label(function ($row, Column $column) {
                    $delete_route = route('admin.subscriptions.destroy', $row->id);
                    $edit_route = route('admin.subscriptions.edit', $row->id);
                    $edit_callback = 'setValue';
                    $modal = '#edit-subscription-modal';
            ...
            Column::make('status')
                ->format(function ($value, $data, Column $column) {
                    $route = route('admin.subscriptions.status');
    ...
    {
        $modelData = new Subscription;
        return Excel::download(new CustomExport($this->getSelected(), $modelData), 'subscriptions.xlsx');
    }
}
